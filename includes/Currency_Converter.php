...
class Currency_Converter
{
    ...
    private function load_dependencies()
    {
         ...
         * core plugin.
         */
        require_once plugin_dir_path(dirname(__FILE__)) . 'includes/Currency_Converter_Loader.php';

        /**
         * The class responsible for defining internationalization functionality
         * of the plugin.
         */
        require_once plugin_dir_path(dirname(__FILE__)) . 'includes/Currency_Converter_i18n.php';

        /**
         * The class responsible for defining all actions that occur in the admin area.
         */
        require_once plugin_dir_path(dirname(__FILE__)) . 'admin/Currency_Converter_Admin.php';

        /**
         * The class responsible for defining all actions that occur in the gutenberg blocks
         * side of the site.
         */
        require_once plugin_dir_path(dirname(__FILE__)) . 'blocks/Currency_Converter_Blocks.php';
        require_once plugin_dir_path(dirname(__FILE__)) . 'blocks/currency-converter/Currency_Converter_Renderer.php';


        /**
         * The class responsible for defining all actions that occur in REST API
         */
        require_once plugin_dir_path(dirname(__FILE__)) . 'rest-api/Currency_Converter_Rest_Api.php';

        /**
         * The class responsible for fetch currency rates from external data sources
         */
        require_once plugin_dir_path(dirname(__FILE__)) . 'data/Currency_Converter_Data_Interface.php';
        require_once plugin_dir_path(dirname(__FILE__)) . 'data/Currency_Converter_Data_ExchangeratesapiIo.php';
        require_once plugin_dir_path(dirname(__FILE__)) . 'data/Currency_Converter_Data_FixerIo.php';
        require_once plugin_dir_path(dirname(__FILE__)) . 'data/Currency_Converter_Data.php';
